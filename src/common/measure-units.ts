...
export const DEFAULT_MEASURE_UNITS: MeasureUnit[] = [
  ...
  { code: 'carton', name: 'Carton', decimalQty: true, active: true, system: true },
  { code: 'dozen', name: 'Dozen', decimalQty: true, active: true, system: true },
  { code: 'pair', name: 'Pair', decimalQty: true, active: true, system: true },
  { code: 'set', name: 'Set', decimalQty: true, active: true, system: true },
